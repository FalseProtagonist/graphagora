...
re_frame$middleware$path.cljs$lang$applyTo = (function (arglist__33750){
...
return cljs.core.get_in.call(null,new_db,p1__33751_SHARP_);
});})(new_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,new_ins){
return (function (p1__33752_SHARP_){
return cljs.core.get_in.call(null,db,p1__33752_SHARP_);
});})(new_db,new_ins))
,in_paths);
...
while (G__33753__i < G__33753__a.length) {G__33753__a[G__33753__i] = arguments[G__33753__i + 2]; ++G__33753__i;}
  in_paths = new cljs.core.IndexedSeq(G__33753__a,0);
} 
...
re_frame$middleware$on_changes.cljs$lang$applyTo = (function (arglist__33754){
var f = cljs.core.first(arglist__33754);
arglist__33754 = cljs.core.next(arglist__33754);
var out_path = cljs.core.first(arglist__33754);
var in_paths = cljs.core.rest(arglist__33754);
