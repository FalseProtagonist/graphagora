...
clojure.browser.event.IEventType = (function (){var obj28761 = {};
return obj28761;
})();
...
return (function (){var or__27653__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__28297__auto__)]);
if(or__27653__auto__){
return or__27653__auto__;
} else {
var or__27653__auto____$1 = (clojure.browser.event.event_types["_"]);
...
var this$__$1 = this;
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,((function (this$__$1){
return (function (p__28764){
var vec__28765 = p__28764;
var k = cljs.core.nth.call(null,vec__28765,(0),null);
var v = cljs.core.nth.call(null,vec__28765,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
