...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__29504__auto__,writer__29505__auto__,opt__29506__auto__){
return cljs.core._write.call(null,writer__29505__auto__,"reagent.impl.template/NativeWrapper");
});
...
var or__28906__auto__ = reagent.impl.template.named_QMARK_.call(null,x);
...
var or__28906__auto__ = reagent.impl.template.hiccup_tag_QMARK_.call(null,x);
if(cljs.core.truth_(or__28906__auto__)){
return or__28906__auto__;
} else {
...
var G__37183 = o;
(G__37183[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
return (function() { 
var G__37184__delegate = function (args){
...
while (G__37185__i < G__37185__a.length) {G__37185__a[G__37185__i] = arguments[G__37185__i + 0]; ++G__37185__i;}
  args = new cljs.core.IndexedSeq(G__37185__a,0);
} 
return G__37184__delegate.call(this,args);};
G__37184.cljs$lang$maxFixedArity = 0;
G__37184.cljs$lang$applyTo = (function (arglist__37186){
var args = cljs.core.seq(arglist__37186);
return G__37184__delegate(args);
});
...
var old_37187 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_37187))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_37187)].join(''):class$));
} else {
}
...
if(cljs.core.not.call(null,(function (){var and__28894__auto__ = (node === document.activeElement);
if(and__28894__auto__){
var and__28894__auto____$1 = reagent.impl.template.has_selection_api_QMARK_.call(null,(node["type"]));
...
if(cljs.core.truth_((function (){var and__28894__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__37190 = jsprops;
(G__37190["defaultValue"] = value);

(G__37190["onChange"] = ((function (G__37190,v,value,on_change){
return (function (p1__37188_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__37188_SHARP_);
});})(G__37190,v,value,on_change))
);
...
var vec__37192 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__37192,(0),null);
var id = cljs.core.nth.call(null,vec__37192,(1),null);
var class$ = cljs.core.nth.call(null,vec__37192,(2),null);
...
var temp__4427__auto__ = (function (){var G__37196 = cljs.core.meta.call(null,v);
var G__37196__$1 = (((G__37196 == null))?null:reagent.impl.template.get_key.call(null,G__37196));
return G__37196__$1;
})();
if((temp__4427__auto__ == null)){
...
var jsprops = {"argv": v};
var G__37198_37199 = v;
var G__37198_37200__$1 = (((G__37198_37199 == null))?null:reagent.impl.template.key_from_vec.call(null,G__37198_37199));
var G__37198_37201__$2 = (((G__37198_37200__$1 == null))?null:(jsprops["key"] = G__37198_37200__$1));
...
var p = (function (){var temp__4427__auto__ = (function (){var G__37204 = cljs.core.meta.call(null,argv);
var G__37204__$1 = (((G__37204 == null))?null:reagent.impl.template.get_key.call(null,G__37204));
return G__37204__$1;
})();
if((temp__4427__auto__ == null)){
return jsprops;
...
var G__37205 = (((jsprops == null))?{}:jsprops);
(G__37205["key"] = key);
...
var G__37206 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__37206;
continue;
}
} else {
...
var n__29809__auto___37207 = a.length;
var i_37208 = (0);
while(true){
if((i_37208 < n__29809__auto___37207)){
(a[i_37208] = reagent.impl.template.as_element.call(null,(a[i_37208])));
...
var a = cljs.core.into_array.call(null,s);
var n__29809__auto___37210 = a.length;
var i_37211 = (0);
while(true){
if((i_37211 < n__29809__auto___37210)){
var val_37212 = (a[i_37211]);
if((cljs.core.vector_QMARK_.call(null,val_37212)) && ((reagent.impl.template.key_from_vec.call(null,val_37212) == null))){
(o["no-key"] = true);
} else {
}

(a[i_37211] = reagent.impl.template.as_element.call(null,val_37212));

var G__37213 = (i_37211 + (1));
i_37211 = G__37213;
continue;
} else {
}
...
if(cljs.core.truth_((function (){var and__28894__auto__ = cljs.core.not.call(null,reagent.impl.component._STAR_non_reactive_STAR_);
if(and__28894__auto__){
return (ctx["no-key"]);
} else {
return and__28894__auto__;
...
var G__37215 = (cljs.core.count.call(null,argv) - first_child);
switch (G__37215) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__37215){
